/* environement.c generated by valac 0.26.1, the Vala compiler
...
void lxsession_lxsession_env_set_misc (LxsessionLxsessionEnv* self) {
	...
	LxsessionLxsessionConfigKeyFile* _tmp15_ = NULL;
	gchar* _tmp16_ = NULL;
	gchar* _tmp17_ = NULL;
	gboolean _tmp18_ = FALSE;
	LxsessionLxsessionConfigKeyFile* _tmp19_ = NULL;
	gchar* _tmp20_ = NULL;
	gchar* _tmp21_ = NULL;
	...
	LxsessionLxsessionConfigKeyFile* _tmp33_ = NULL;
	gchar* _tmp34_ = NULL;
	gchar* _tmp35_ = NULL;
	gboolean _tmp36_ = FALSE;
	LxsessionLxsessionConfigKeyFile* _tmp37_ = NULL;
	gchar* _tmp38_ = NULL;
	gchar* _tmp39_ = NULL;
...
" -remove _NET_CURRENT_DESKTOP");
	...
	_tmp6_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp5_, "Environment", "toolkit_integration", NULL);
	_tmp7_ = _tmp6_;
	_tmp8_ = g_strcmp0 (_tmp7_, "true") == 0;
	_g_free0 (_tmp7_);
	if (_tmp8_) {
		gchar* toolkit_variable = NULL;
		LxsessionLxsessionConfigKeyFile* _tmp9_ = NULL;
		gchar* _tmp10_ = NULL;
		const gchar* _tmp11_ = NULL;
		const gchar* _tmp12_ = NULL;
		GQuark _tmp14_ = 0U;
		...
		_tmp10_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp9_, "Environment", "toolkit_integration", NULL);
		toolkit_variable = _tmp10_;
		_tmp11_ = toolkit_variable;
		_tmp12_ = _tmp11_;
		_tmp14_ = (NULL == _tmp12_) ? 0 : g_quark_from_string (_tmp12_);
		if (_tmp14_ == ((0 != _tmp13_label0) ? _tmp13_label0 : (_tmp13_label0 = g_quark_from_static_string ("gtk2")))) {
			switch (0) {
				default:
				{
		...
		} else if (_tmp14_ == ((0 != _tmp13_label1) ? _tmp13_label1 : (_tmp13_label1 = g_quark_from_static_string ("gtk3")))) {
			switch (0) {
				default:
				{
		...
		} else if (_tmp14_ == ((0 != _tmp13_label2) ? _tmp13_label2 : (_tmp13_label2 = g_quark_from_static_string ("gtk")))) {
			switch (0) {
				default:
				{
					g_setenv ("SAL_USE_VCLPLUGIN", "gtk", TRUE);
		...
		} else if (_tmp14_ == ((0 != _tmp13_label3) ? _tmp13_label3 : (_tmp13_label3 = g_quark_from_static_string ("gen")))) {
			switch (0) {
				default:
				{
		...
		} else if (_tmp14_ == ((0 != _tmp13_label4) ? _tmp13_label4 : (_tmp13_label4 = g_quark_from_static_string ("kde4")))) {
			switch (0) {
				default:
				{
		...
		} else if (_tmp14_ == ((0 != _tmp13_label5) ? _tmp13_label5 : (_tmp13_label5 = g_quark_from_static_string ("kde")))) {
			switch (0) {
				default:
				{
					g_setenv ("SAL_USE_VCLPLUGIN", "kde4", TRUE);
		...
		} else if (_tmp14_ == ((0 != _tmp13_label6) ? _tmp13_label6 : (_tmp13_label6 = g_quark_from_static_string ("qt")))) {
			switch (0) {
				default:
				{
					g_setenv ("SAL_USE_VCLPLUGIN", "kde4", TRUE);
		...
		} else if (_tmp14_ == ((0 != _tmp13_label7) ? _tmp13_label7 : (_tmp13_label7 = g_quark_from_static_string ("qt4")))) {
			switch (0) {
				default:
				{
					g_setenv ("SAL_USE_VCLPLUGIN", "kde4", TRUE);
	...
	_tmp16_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp15_, "Environment", "gtk", "overlay_scrollbar_disable");
	_tmp17_ = _tmp16_;
	_tmp18_ = g_strcmp0 (_tmp17_, "true") == 0;
	_g_free0 (_tmp17_);
	if (_tmp18_) {
		g_setenv ("GTK_OVERLAY_SCROLLING", "0", TRUE);
	}
	_tmp19_ = lxsession_global_settings;
	_tmp20_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp19_, "Environment", "qt", "force_theme");
	_tmp21_ = _tmp20_;
	_tmp22_ = _tmp21_ != NULL;
	_g_free0 (_tmp21_);
	if (_tmp22_) {
		LxsessionLxsessionConfigKeyFile* _tmp23_ = NULL;
		gchar* _tmp24_ = NULL;
		gchar* _tmp25_ = NULL;
		_tmp23_ = lxsession_global_settings;
		_tmp24_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp23_, "Environment", "qt", "force_theme");
		_tmp25_ = _tmp24_;
		g_setenv ("QT_STYLE_OVERRIDE", _tmp25_, TRUE);
		_g_free0 (_tmp25_);
	}
	_tmp26_ = g_getenv ("QT_PLUGIN_PATH");
	...
	_tmp33_ = lxsession_global_settings;
	_tmp34_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp33_, "Environment", "ubuntu_menuproxy", NULL);
	_tmp35_ = _tmp34_;
	_tmp36_ = g_strcmp0 (_tmp35_, "true") == 0;
	_g_free0 (_tmp35_);
	if (_tmp36_) {
		g_setenv ("UBUNTU_MENUPROXY", "libappmenu.so", TRUE);
	}
	_tmp37_ = lxsession_global_settings;
	_tmp38_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp37_, "Session", "im_manager", "command");
	_tmp39_ = _tmp38_;
	_tmp40_ = _tmp39_ != NULL;
	_g_free0 (_tmp39_);
	if (_tmp40_) {
		LxsessionLxsessionConfigKeyFile* _tmp41_ = NULL;
		gchar* _tmp42_ = NULL;
		gchar* _tmp43_ = NULL;
		LxsessionLxsessionConfigKeyFile* _tmp44_ = NULL;
		gchar* _tmp45_ = NULL;
		gchar* _tmp46_ = NULL;
		LxsessionLxsessionConfigKeyFile* _tmp47_ = NULL;
		gchar* _tmp48_ = NULL;
		gchar* _tmp49_ = NULL;
		_tmp41_ = lxsession_global_settings;
		_tmp42_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp41_, "Session", "im_manager", "command");
		_tmp43_ = _tmp42_;
		g_setenv ("GTK_IM_MODULE", _tmp43_, TRUE);
		_g_free0 (_tmp43_);
		_tmp44_ = lxsession_global_settings;
		_tmp45_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp44_, "Session", "im_manager", "command");
		_tmp46_ = _tmp45_;
		g_setenv ("QT_IM_MODULE", _tmp46_, TRUE);
		_g_free0 (_tmp46_);
		_tmp47_ = lxsession_global_settings;
		_tmp48_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp47_, "Session", "im_manager", "command");
		_tmp49_ = _tmp48_;
		g_setenv ("XMODIFIERS=@im", _tmp49_, TRUE);
		_g_free0 (_tmp49_);
	}
	_tmp50_ = lxsession_global_settings;
	_tmp51_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp50_, "Environment", "qt", "platform");
	_tmp52_ = _tmp51_;
	...
	if (_tmp53_) {
		...
		gchar* _tmp55_ = NULL;
		gchar* _tmp56_ = NULL;
		LxsessionLxsessionConfigKeyFile* _tmp57_ = NULL;
		gchar* _tmp58_ = NULL;
		gchar* _tmp59_ = NULL;
		_tmp54_ = lxsession_global_settings;
		_tmp55_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp54_, "Environment", "qt", "platform");
		_tmp56_ = _tmp55_;
		g_setenv ("QT_PLATFORM_PLUGIN", _tmp56_, TRUE);
		_g_free0 (_tmp56_);
		_tmp57_ = lxsession_global_settings;
		_tmp58_ = lxsession_lxsession_config_get_item_string ((LxsessionLxsessionConfig*) _tmp57_, "Environment", "qt", "platform");
		_tmp59_ = _tmp58_;
		g_setenv ("QT_QPA_PLATFORMTHEME", _tmp59_, TRUE);
		_g_free0 (_tmp59_);
	}
	_g_free0 (qt_plugin);
	_g_free0 (dbus_env);
